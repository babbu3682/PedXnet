...
def General_Fracture_Dataset(mode, data_folder_dir="/workspace/sunggu/1.Hemorrhage/SMART-Net/datasets/samples"):  
    if mode == 'train':
...
# TEST
def General_Fracture_Dataset_TEST(data_folder_dir="/workspace/sunggu/1.Hemorrhage/SMART-Net/datasets/samples"):
