...
def main(args):
    ...
    data_loader_test = torch.utils.data.DataLoader(dataset_test, batch_size=1, num_workers=args.num_workers, shuffle=False, pin_memory=args.pin_mem, drop_last=False, collate_fn=collate_fn)
    ...
    model = create_model(stream=args.training_stream, name=args.model_name, pretrained=None, backbone_name=args.backbone_name, freeze_backbone=None)
